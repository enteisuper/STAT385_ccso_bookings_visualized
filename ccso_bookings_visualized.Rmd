...
```{r}
# this part is for printing/debugging, can delete this section when done
# list of all histograms and names
#histogram_white
#histogram_hispanic
#histogram_white_hispanic
#histogram_black
#histogram_asian
#histogram_native_american
#histogram_race_unknown
#histogram_married
#histogram_single
#histogram_seperated
#histogram_significant_other
#histogram_divorced
#histogram_widowed
#histogram_marriage_unknown
#histogram_male
#histogram_female
#histogram_champaign
#histogram_urbana
...
server <- function(input, output) {
    output$Plot <- renderPlot({
        ...
        ggplot(data = dat) +
            geom_histogram(aes(x = TimeSpentInJail)) +
            theme_minimal()
    })
}
# Run the app
