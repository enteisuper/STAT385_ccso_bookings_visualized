...
ccso_bookings = data %>% 
    ...
    select(RACE, SEX, CITY, MARITIAL.STATUS, Booking.Date.Time, time.spent.in.jail) %>%
    rename(Race = RACE, Sex = SEX, City = CITY, MaritalStatus = MARITIAL.STATUS, BookingDateTime = Booking.Date.Time, TimeSpentInJail = time.spent.in.jail) 
